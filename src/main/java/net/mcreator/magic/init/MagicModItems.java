...
public class MagicModItems {
	...
	public static final RegistryObject<Item> TEST_SPAWN_EGG = REGISTRY.register("test_spawn_egg", () -> new ForgeSpawnEggItem(MagicModEntities.TEST, -1, -1, new Item.Properties()));
