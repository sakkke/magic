...
public class TestEntity extends Monster {
	public TestEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MagicModEntities.TEST.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(MagicModEntities.TEST.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
